...
public class ReservationController {
	...
	@GetMapping("/book")
	public Long book(@RequestParam String name, @RequestParam String from, @RequestParam String to) {
		log.info("Booking a flight for " + name);
		return reservationService.book(name, from, to);
	}
